...
const card = ["static/images/2.png", "static/images/3.png", "static/images/4.png", "static/images/5.png",
    "static/images/6.png", "static/images/7.png", "static/images/8.png", "static/images/9.png",
    "static/images/10.png", "static/images/A.png", "static/images/J.png", "static/images/Q.png",
    "static/images/K.png"];
...
// Note: Port number of your local host may be different 
    ...
    if (img.src === "http://localhost:63342/blackjack%20using%20js/static/images/2.png") {
        ...
        player["score"] += 3;
    } else if (img.src === "http://localhost:63342/blackjack%20using%20js/static/images/4.png") {
        player["score"] += 4;
    } else if (img.src === "http://localhost:63342/blackjack%20using%20js/static/images/5.png") {
        player["score"] += 5;
    } else if (img.src === "http://localhost:63342/blackjack%20using%20js/static/images/6.png") {
        player["score"] += 6;
    } else if (img.src === "http://localhost:63342/blackjack%20using%20js/static/images/7.png") {
        player["score"] += 7;
    } else if (img.src === "http://localhost:63342/blackjack%20using%20js/static/images/8.png") {
        player["score"] += 8;
    } else if (img.src === "http://localhost:63342/blackjack%20using%20js/static/images/9.png") {
        player["score"] += 9;
    } else if (img.src === "http://localhost:63342/blackjack%20using%20js/static/images/10.png") {
        player["score"] += 10;
    } else if (img.src === "http://localhost:63342/blackjack%20using%20js/static/images/J.png") {
        player["score"] += 10;
    } else if (img.src === "http://localhost:63342/blackjack%20using%20js/static/images/Q.png") {
        player["score"] += 10;
    } else if (img.src === "http://localhost:63342/blackjack%20using%20js/static/images/K.png") {
        player["score"] += 10;
    } else if (img.src === "http://localhost:63342/blackjack%20using%20js/static/images/A.png") {
        player["score"] += 1;
    }
}
...
function gameResult() {
    ...
    if (yourStuff["score"] <= 21) {
        if ((yourStuff["score"] > botStuff["score"]) || (botStuff["score"] > 21)) {
            winner = yourStuff;
        } else if ((botStuff["score"] <= 21) && (yourStuff["score"] < botStuff["score"])) {
            winner = botStuff;
